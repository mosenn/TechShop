  ...
  return (
    <main className="hidden  tab:grid   bg-linear-to-b from-brand-bg via-brand-bg-section/60 to-brand-bg-section/60 rounded-xl border border-[#565656]">
      <div className="gap-5 flex flex-col p-2">
        ...
        {/* picture */}
        <section
          className="relative mx-auto aspect-video w-full tab:max-w-175 des:max-w-[97%] bg-transparent group"
      ...
      <div className=" flex justify-center p-2 ">
        <section className="grid grid-cols-2 my-4 w-full max-w-175 des:max-w-[97%] ">
          {/* left box */}
