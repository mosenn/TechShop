...
const MobileHero = () => {
  return (
    <main className=" grid tab:grid-cols-2 items-start xl:hidden  relative ">
      ...
      <div className="tab:hidden  flex border w-full justify-center top-[-35px] sm5:top-[-55px]  absolute">
        <h1 className=" w-full max-w-[350px] font-bold text-[64px] sm5:border  text-center">
      ...
      {/* text & buttons */}
      <section className="grid tab:flex flex-col border justify-end tab:justify-center  text-right tab:h-screen">
        {/* text */}
        <section className="grid tab:flex flex-col gap-2 text-right  ">
          ...
          {/* buttons */}
          <div className="flex justify-end border py-4">
